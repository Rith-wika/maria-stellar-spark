...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "St. Maria High School, Lalitha Bagh, Uppuguda, Hyderabad. English-medium State Board school with 100% SSC results and 45+ years of excellence. Admissions open 2026-27." },
