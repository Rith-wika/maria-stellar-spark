...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "45+ years of nurturing young minds through values-driven, quality education." },
  ...
  component: () => (
    <>
      <PageHero eyebrow="About Us" title="Our Story Since 1980" description="A legacy built on excellence, integrity, and care for every child." />
      <About />
      <VisionMission />
      <Principal />
    </>
